...
// Single world event with heat-coded styling
// ============================================
...
export default function EventCard({ event }) {
  ...
  const getHeatStyle = (score) => {
    ...
    return {
      ...
      glowColor: "rgba(0, 204, 0, 0.1)",
    };
  };

  const getHeatEmoji = (score) => {
    if (score >= 8) return "🔴";
    if (score >= 6) return "🟠";
    if (score >= 4) return "🟡";
    if (score >= 2) return "🔵";
  ...
  return (
    <div
      ...
      onMouseOut={(e) => {
        e.currentTarget.style.backgroundColor = heatStyle.backgroundColor;
      }}
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: "12px" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: "14px" }}>{getHeatEmoji(heat)}</span>
            ...
            <span style={{
              ...
              {(event.category || "general").replace(/_/g, " ")}
            </span>
