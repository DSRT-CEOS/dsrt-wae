...
export default function GlobalHomepage() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0a0e1a", color: "#E8EAED", fontFamily: "'Inter', sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: "1400px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px" }}>
          ...
          <nav style={{ display: "flex", gap: "20px", alignItems: "center", fontSize: "13px" }}>
            <a href="/global" style={{ ...navLink, color: "#3B82F6", fontWeight: "700" }}>Latest</a>
            <a href="/global/brief" style={navLink}>The Brief</a>
            <a href="/global/pulse" style={navLink}>🌍 World Pulse</a>
      ...
      />
      <HeadlineTicker 
        bucket="tech_lifestyle" 
        direction="left" 
        label="TECH · CLIMATE · CULTURE" 
        accentColor="#4ADE80"
        speed={140}
      />

      {/* HERO — TODAY'S INTELLIGENCE BRIEF */}
      {brief && (
        <section style={{
          background: "linear-gradient(135deg, rgba(59, 130, 246, 0.1), rgba(168, 85, 247, 0.06), rgba(10, 14, 26, 0.5))",
          borderBottom: "1px solid #1F2937",
          padding: "48px 24px",
        }}>
          <div style={{ maxWidth: "1400px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "center" }} className="hero-grid">
            
            <div>
              <div style={{ fontSize: "12px", letterSpacing: "2px", color: "#3B82F6", marginBottom: "12px", fontWeight: "700", textTransform: "uppercase", display: "flex", alignItems: "center", gap: "8px" }}>
                📊 Today's Intelligence Brief
              </div>
              <h1 style={{ fontSize: "40px", fontWeight: "800", color: "#FFFFFF", margin: "0 0 12px 0", lineHeight: "1.1", display: "flex", alignItems: "baseline", gap: "12px", flexWrap: "wrap" }}>
                Global DSRT Heat Index:
                <span style={{ color: getHeatColor(brief.global_heat_index), fontSize: "52px" }}>
                  {brief.global_heat_index}
                </span>
              </h1>
              <div style={{ fontSize: "15px", color: "#9CA3AF", margin: "0 0 24px 0", lineHeight: "1.6" }}>
              ...
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                ...
                <button 
                  onClick={() => router.push("/global/pulse")}
                  style={{
                    padding: "14px 24px", backgroundColor: "transparent", color: "#60A5FA",
                    border: "1px solid #3B82F6", borderRadius: "8px", fontSize: "14px",
                    fontWeight: "700", cursor: "pointer", letterSpacing: "0.5px",
                  }}
                >
            ...
            <div>
              <div style={{ fontSize: "12px", letterSpacing: "2px", color: "#6B7280", marginBottom: "16px", textTransform: "uppercase", fontWeight: "700" }}>
                5 Things to Know
              </div>
              <ol style={{ margin: 0, padding: 0, listStyle: "none" }}>
                {(brief.headlines || []).slice(0, 5).map((h, i) => (
                  ...
                  >
                    <span style={{ color: "#3B82F6", fontWeight: "800", minWidth: "24px", fontSize: "16px" }}>{i + 1}.</span>
                    <span style={{ color: "#D1D5DB", lineHeight: "1.5", fontSize: "14px" }}>{h.headline}</span>
                  </li>
                ))}
              </ol>
            </div>
      ...
      <main style={{ maxWidth: "1400px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        {loading ? (
          ...
          <>
            {featuredArticle && (
              ...
              >
                <div style={{ display: "flex", gap: "8px", marginBottom: "20px", flexWrap: "wrap" }}>
                  ...
                  {featuredArticle.article_type === "breaking" && <span style={breakingBadge}>● BREAKING</span>}
                  <span style={metaBadge}>{featuredArticle.reading_time_minutes || 3} min read</span>
                  <span style={{ ...metaBadge, color: "#60A5FA", borderColor: "rgba(96, 165, 250, 0.3)" }}>FEATURED</span>
                </div>
                <h2 style={{ fontSize: "40px", fontWeight: "800", color: "#FFFFFF", margin: "0 0 16px 0", lineHeight: "1.15" }}>
                  {featuredArticle.title}
                </h2>
                {featuredArticle.subtitle && (
                  <p style={{ fontSize: "20px", color: "#9CA3AF", margin: "0 0 24px 0", lineHeight: "1.5" }}>
                    {featuredArticle.subtitle}
                  </p>
                )}
                <div style={{ display: "flex", alignItems: "center", gap: "12px", fontSize: "13px", color: "#6B7280" }}>
                  <span style={{ width: "36px", height: "36px", borderRadius: "50%", backgroundColor: "#3B82F6", color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "14px", fontWeight: "700" }}>
                    {agentLabel(featuredArticle.agent_persona).charAt(0)}
                  </span>
                  <div>
                    <div style={{ color: "#FFFFFF", fontWeight: "600" }}>By {agentLabel(featuredArticle.agent_persona)}</div>
                    <div style={{ fontSize: "11px" }}>
                      {fmtDate(featuredArticle.published_at)}
                      {featuredArticle.region && ` · 📍 ${featuredArticle.region}`}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div style={{ fontSize: "11px", letterSpacing: "2px", color: "#6B7280", marginBottom: "20px", fontWeight: "700", textTransform: "uppercase", borderBottom: "1px solid #1F2937", paddingBottom: "12px" }}>
              📰 Latest Analysis ({restArticles.length})
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: "20px" }}>
              {restArticles.map(article => (
                <article
                  ...
                  onMouseOut={(e) => { e.currentTarget.style.borderColor = "#1F2937"; e.currentTarget.style.transform = "translateY(0)"; }}
                >
                  ...
                  <h3 style={{ fontSize: "18px", fontWeight: "700", color: "#FFFFFF", margin: "0 0 10px 0", lineHeight: "1.35", flex: 1 }}>
                    {article.title}
                  </h3>
                  {article.summary_short && (
                    <p style={{ fontSize: "13px", color: "#9CA3AF", margin: "0 0 14px 0", lineHeight: "1.55" }}>
                      {article.summary_short}
                    </p>
                  )}
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "auto", paddingTop: "12px", borderTop: "1px solid #1F2937", fontSize: "11px", color: "#6B7280" }}>
                    <span style={{ color: "#60A5FA", fontWeight: "600" }}>{agentLabel(article.agent_persona)}</span>
        ...
        {/* Newsletter CTA */}
        <section style={{ marginTop: "64px", padding: "48px 32px", background: "linear-gradient(135deg, #1E40AF, #6D28D9)", borderRadius: "16px", textAlign: "center" }}>
          <h2 style={{ fontSize: "28px", fontWeight: "700", color: "#FFFFFF", margin: "0 0 12px 0" }}>Get The DSRT Brief</h2>
          <p style={{ fontSize: "15px", color: "#E0E7FF", margin: "0 0 24px 0", maxWidth: "500px", marginLeft: "auto", marginRight: "auto" }}>
            5 things you need to know about the world, every morning. Free.
          </p>
          <form onSubmit={handleSubscribe} style={{ display: "flex", gap: "8px", maxWidth: "440px", margin: "0 auto", flexWrap: "wrap", justifyContent: "center" }}>
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="your@email.com" required
              style={{ flex: "1 1 240px", padding: "12px 16px", backgroundColor: "rgba(255,255,255,0.95)", border: "none", borderRadius: "8px", fontSize: "14px", fontFamily: "inherit", outline: "none", color: "#111827" }} />
            <button type="submit" style={{ padding: "12px 24px", backgroundColor: "#FFFFFF", color: "#1E40AF", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "700", cursor: "pointer", letterSpacing: "0.5px" }}>
              SUBSCRIBE FREE
            </button>
          </form>
          {subscribeStatus && (
            <div style={{ marginTop: "16px", fontSize: "13px", color: subscribeStatus.ok ? "#86EFAC" : "#FCA5A5", fontWeight: "600" }}>
      ...
      <footer style={{ borderTop: "1px solid #1F2937", padding: "32px 24px", marginTop: "64px", backgroundColor: "#0F1623" }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px", fontSize: "12px", color: "#6B7280" }}>
          <div><strong style={{ color: "#D1D5DB" }}>DSRT GLOBAL</strong> · A DSRT Group Company · Powered by DSRT WAE</div>
          <div style={{ display: "flex", gap: "20px" }}>
            ...
            <a href="/global/pulse" style={{ color: "#6B7280", textDecoration: "none" }}>Pulse</a>
            <a href="/" style={{ color: "#3B82F6", textDecoration: "none" }}>WAE →</a>
          </div>
        </div>
      </footer>
...
const navLink = { color: "#D1D5DB", textDecoration: "none", fontSize: "13px", fontWeight: "500", letterSpacing: "0.3px" };
const metaBadge = { fontSize: "11px", padding: "3px 10px", backgroundColor: "rgba(107, 114, 128, 0.15)", color: "#9CA3AF", borderRadius: "4px", fontWeight: "500", border: "1px solid rgba(107, 114, 128, 0.3)" };
const breakingBadge = { fontSize: "11px", padding: "3px 10px", backgroundColor: "rgba(239, 68, 68, 0.15)", color: "#F87171", border: "1px solid rgba(239, 68, 68, 0.3)", borderRadius: "4px", fontWeight: "700", letterSpacing: "0.5px" };
...
function categoryBadge(cat) {
  ...
  return { fontSize: "10px", padding: "3px 10px", backgroundColor: c.bg, color: c.color, border: `1px solid ${c.border}`, borderRadius: "4px", fontWeight: "700", letterSpacing: "0.8px", textTransform: "uppercase" };
}
